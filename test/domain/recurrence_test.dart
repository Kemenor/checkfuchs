...
void main() {
  group('daily', () {
    test('every day', () {
      expect(
        firstN(Recurrence.daily(d(2026, 6, 27)), 3),
        [d(2026, 6, 27), d(2026, 6, 28), d(2026, 6, 29)],
      );
    });

    test('every 3 days, anchored', () {
      expect(
        firstN(Recurrence.daily(d(2026, 6, 27), interval: 3), 3),
        [d(2026, 6, 27), d(2026, 6, 30), d(2026, 7, 3)],
      );
    });
  });
  ...
  group('weekly', () {
    test('every other Saturday from a Saturday anchor', () {
      final r = Recurrence.weekly(d(2026, 6, 27), interval: 2, on: {Weekday.sat});
      expect(firstN(r, 3), [d(2026, 6, 27), d(2026, 7, 11), d(2026, 7, 25)]);
    });

    test('Mon + Thu weekly, anchored mid-week (Wed)', () {
      final r = Recurrence.weekly(d(2026, 6, 24), on: {Weekday.mon, Weekday.thu});
      // anchor Wed 24th: Mon 22nd is before the anchor (skipped), Thu 25th kept.
      expect(firstN(r, 4),
          [d(2026, 6, 25), d(2026, 6, 29), d(2026, 7, 2), d(2026, 7, 6)]);
    });
  ...
  group('lookups', () {
    ...
    test('from in the middle of a weekly interval lands on the next active day', () {
      final r = Recurrence.weekly(d(2026, 6, 27), interval: 2, on: {Weekday.sat});
