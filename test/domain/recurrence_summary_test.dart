...
void main() {
  ...
  test('daily', () {
    ...
    expect(recurrenceSummary(Recurrence.daily(d(2026, 6, 27), interval: 3)),
        'Every 3 days');
  });
  ...
  test('weekly', () {
    expect(
      recurrenceSummary(
          Recurrence.weekly(d(2026, 6, 27), on: {Weekday.sat})),
      'Every Saturday',
    );
    expect(
      recurrenceSummary(
  ...
  test('monthly', () {
    expect(recurrenceSummary(Recurrence.monthly(d(2026, 6, 10), day: 25)),
    ...
    expect(
        recurrenceSummary(
            Recurrence.monthly(d(2026, 6, 1), interval: 2, day: 1)),
  ...
  test('yearly', () {
    expect(
      recurrenceSummary(
          Recurrence.yearly(d(2026, 3, 13), month: 3, day: 13)),
      'Every year on 13 March',
    );
  });

  test('ordinals', () {
    expect(recurrenceSummary(Recurrence.monthly(d(2026, 1, 2), day: 2)),
        'On the 2nd of every month');
    expect(recurrenceSummary(Recurrence.monthly(d(2026, 1, 3), day: 3)),
        'On the 3rd of every month');
    expect(recurrenceSummary(Recurrence.monthly(d(2026, 1, 11), day: 11)),
        'On the 11th of every month');
    expect(recurrenceSummary(Recurrence.monthly(d(2026, 1, 21), day: 21)),
