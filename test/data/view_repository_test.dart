...
void main() {
  ...
  test('seedDefaults creates a Home view + an All-tasks lens (idempotent)',
      () async {
  ...
  test('a View renders its lens through derive', () async {
    ...
    await taskRepo.createTemplate(Template(
      name: 'Brush teeth',
    ...
    final state =
        await viewRepo.watchViewState(home.id, d(2026, 6, 27, 8)).first;
